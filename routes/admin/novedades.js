...
router.get('/', async function (req, res, next) {
    ...
    var novedad;
    //buscador
    if (req.query.q === undefined){ //si en el buscador no buscamos nada nos muestra todas las novedades
        novedad = await novedadesModel.getNovedades();
    }else{
        novedad = await novedadesModel.buscarNovedades(req.query.q)// si pusimos para buscar algo, nos muestra los resultados
    }
    ...
    novedad = novedad.map(novedad => {
        if (novedad.img_id) {
            ...
            return {
                ...
                imgane: '/images/noimage.jpg'//nada
            }
        }
    });
